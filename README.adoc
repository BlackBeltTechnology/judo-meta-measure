...
It contains measure meta model.
...
https://github.com/BlackBeltTechnology/judo-meta-measure/releases
...
https://app.wercker.com/BlackbeltTechnology/judo-meta-measure/runs
