...
public class MeasureAdapterFactory extends AdapterFactoryImpl {
	...
	protected MeasureSwitch<Adapter> modelSwitch =
		new MeasureSwitch<Adapter>() {
			...
			@Override
			public Adapter caseBaseMeasure(BaseMeasure object) {
				return createBaseMeasureAdapter();
			}
			@Override
			public Adapter caseBaseMeasureTerm(BaseMeasureTerm object) {
				return createBaseMeasureTermAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.blackbelt.judo.meta.measure.Measure <em>Measure</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.blackbelt.judo.meta.measure.Unit <em>Unit</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.blackbelt.judo.meta.measure.DerivedMeasure <em>Derived Measure</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.blackbelt.judo.meta.measure.BaseMeasure <em>Base Measure</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createBaseMeasureAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link hu.blackbelt.judo.meta.measure.BaseMeasureTerm <em>Base Measure Term</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createBaseMeasureTermAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link hu.blackbelt.judo.meta.measure.DurationUnit <em>Duration Unit</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
