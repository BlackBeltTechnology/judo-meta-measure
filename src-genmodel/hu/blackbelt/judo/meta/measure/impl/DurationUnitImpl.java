 ...
 * </p>
 * <ul>
 *   <li>{@link hu.blackbelt.judo.meta.measure.impl.DurationUnitImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DurationUnitImpl extends UnitImpl implements DurationUnit {
	 ...
	 * @ordered
	 */
	protected static final DurationType TYPE_EDEFAULT = DurationType.MILLISECOND;
	...
	public void setType(DurationType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MeasurePackage.DURATION_UNIT__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MeasurePackage.DURATION_UNIT__TYPE:
				return getType();
		}
