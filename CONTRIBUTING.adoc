...
* `/feature`: Eclipse feature project
* `/site`: Eclipse site definition
* `/targetdefinition`: Eclipse target definition

Model modules:

* `/model`: Module containing the actual model
* `/model-test`: Module containing model tests

OSGI wrapper:

* `/osgi`: OSGi wrapper module
...
You can file new issues by filling out our https://github.com/BlackBeltTechnology/judo-meta-measure/issues/new/choose[issue form].
